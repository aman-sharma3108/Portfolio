    ...
    return(
        <section className="relative md:py-24 py-16" id="about">
                ...
                <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    <div className="lg:col-span-5 lg:px-8">
                        <div className="relative">
                            ...
                            <img src="/images/suit2.png" className="rounded-full shadow-md shadow-gray-200 dark:shadow-gray-800" alt=""/>
                    ...
                    <div className="lg:col-span-7">
                        <div className="lg:ms-5">
                            <h3 className="mb-6 md:text-2xl text-xl md:leading-normal leading-normal font-semibold">I'm a Passionate Web Developer</h3>
            ...
            <div className="container md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-2 gap-[30px]">
